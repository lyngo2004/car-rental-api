...
const car_prisma_repository_1 = require("./repository/car-prisma.repository");
const car_token_1 = require("./repository/car.token");
        ...
        providers: [car_service_1.CarService,
            {
                ...
                useClass: car_prisma_repository_1.CarPrismaRepository,
            }
        ],
        exports: [car_token_1.CAR_REPOSITORY]
    })
], CarModule);
